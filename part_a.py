...
#connection = analysis.tcp_connections[0]
    num_transactions_to_print = 1
    try:
        PrettyPrint.print_in_tabular_format(
            dataset = [[connection.addr1, connection.addr2, segment.seq_num, segment.ack_num, segment.payload_size, segment.win_size, segment.flags.syn, segment.flags.ack] \
